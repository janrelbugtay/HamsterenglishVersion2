...
new_theme = """          case 'space':
          ...
          default:
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-80 group-hover:opacity-40 transition-opacity duration-500"></div>`,
              letterStyle: 'absolute text-yellow-400 left-[28%] top-[50%] -translate-x-1/2 -translate-y-1/2 rotate-[-8deg] group-hover:scale-110 transition-transform duration-500 drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)]',
              modalIcon: `<img src="https://drive.google.com/thumbnail?id=1ugM0rhtk40XdbSDrdDJja5QpLNkWebQn&sz=w1000" alt="box" referrerpolicy="no-referrer" class="w-14 h-14 object-contain drop-shadow-lg" />`
            };"""

content = content.replace(old_theme, new_theme)

# Update keep button
old_keep = """                    <img src="https://drive.google.com/thumbnail?id=1ugM0rhtk40XdbSDrdDJja5QpLNkWebQn&sz=w1000" alt="box" referrerpolicy="no-referrer" class="w-14 h-14 object-contain drop-shadow-lg" /> KEEP IT"""

new_keep = """                    ${theme.modalIcon} KEEP IT"""
