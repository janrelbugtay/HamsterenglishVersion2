...
old_grid = """            ${!isOpened ? `<img src="https://drive.google.com/thumbnail?id=1ugM0rhtk40XdbSDrdDJja5QpLNkWebQn&sz=w1000" alt="box" referrerpolicy="no-referrer" class="absolute inset-0 w-full h-full object-cover scale-[1.15] group-hover:scale-[1.25] transition-transform duration-500" />` : ""}
...
new_grid = """            ${!isOpened ? `<img src="https://drive.google.com/thumbnail?id=1ugM0rhtk40XdbSDrdDJja5QpLNkWebQn&sz=w2000" alt="box" referrerpolicy="no-referrer" class="absolute inset-0 w-[140%] h-[140%] max-w-none -left-[20%] -top-[15%] object-cover group-hover:scale-[1.05] transition-transform duration-500" />` : ""}
